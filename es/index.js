...
class DrawPolygon {
    constructor(options) {
        ...
        Object.defineProperty(this, "polygonList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: undefined
    ...
    endDrawChange() {
        if (!this.polygonList)
            return;
        let feature = this.polygonList?.toGeoJSON();
        feature.properties = {
            ...feature.properties,
            "fill-color": colorTransform(this.polygonStyle.color, 1),
            "fill-opacity": this.polygonStyle.opacity,
            "line-color": colorTransform(this.lineStyle.color, 1),
...
export { DrawMapLeaflet as default };
